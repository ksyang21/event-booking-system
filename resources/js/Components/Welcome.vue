        ...
        <div class="p-6 lg:p-8 bg-white border-b border-gray-200">
            ...
            <div class="mt-7">
                <div v-if="upcomingEvents.length > 0">
                    <p class="text-xl font-semibold" v-if="upcomingEvents.length > 0">
                        You have <span class="text-blue-500">{{ upcomingEvents.length }}</span> upcoming event<span
                        v-if="upcomingEvents.length > 1">s</span>.
                    </p>

                    <ul class="scale-100">
                        <li v-for="event in upcomingEvents" :key="event.id">
                            <EventListItem :title="event.title" :description="event.description" :date="event.date"
                                           :time="event.time" :location="event.location" :capacity="event.capacity"/>
                        </li>
                    </ul>
                </div>
                <div v-else>
